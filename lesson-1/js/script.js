...
<<<<<<< HEAD
		...
		function updateName() {
			...
			if (newName) {
				teacherEm.textContent = newName;
			}
		}

		// STEP 5: Comment out the addEventListener above, and replace it with an onclick attribute typed directly into the EM element in the HTML 
		// Note: To do this, you would comment out line 34 and add onclick="updateName()" to the <em> tag in your HTML file.
